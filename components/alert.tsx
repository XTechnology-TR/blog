			...
			>
				<div className="nav-container w-container">
					...
					<nav
						id="site-navigation"
						role="navigation"
						className="main-navigation nav-menu w-nav-menu centered"
					>
						<a
							href="https://xtechnology.co/giris"
							className="nav-link hidden-login w-inline-block"
						>
							<div className="nav-link-text">Müşteri Paneli</div>
						</a>
						<a
							data-w-id="kayit-ol"
						...
						>
							<div className="nav-link-text">
								<span style={{ verticalAlign: "inherit" }}>Neler Yaparız</span>
							</div>
							<div
						...
						>
							<div className="nav-link-text">
								<span style={{ verticalAlign: "inherit" }}>Neler Yaptık</span>
							</div>
							<div
								className="nav-link-underline"
								style={{ width: "0px" }}
						...
						<a
							data-w-id="xakademi"
							href="https://magaza.xtechnology.co/"
							className="nav-link w-inline-block"
						>
							<div className="nav-link-text">
								<span style={{ verticalAlign: "inherit" }}>Mağaza</span>
							</div>
							<div
								className="nav-link-underline"
								style={{ width: "0px" }}
						...
						>
							<div className="nav-link-text">
								<span style={{ verticalAlign: "inherit" }}>X-Akademi</span>
							</div>
							<div
								className="nav-link-underline"
						...
						<a
							id="discover"
							data-w-id="kesif"
							href="https://muhasebe.xtechnology.co/"
							className="nav-link w-inline-block"
						>
							<div className="nav-link-text">
								<span style={{ verticalAlign: "inherit" }}>Muhasebe</span>
							</div>
							<div
								className="nav-link-underline"
								style={{ width: "0%", height: "1px" }}
						...
						>
							<div className="nav-link-text">
								<span style={{ verticalAlign: "inherit" }}>Müşteri Destek</span>
							</div>
							<div
								className="nav-link-underline"
								style={{ width: "0%", height: "1px" }}
